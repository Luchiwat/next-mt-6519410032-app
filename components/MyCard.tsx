...
import {  FaFacebookF, FaInstagram, FaLinkedinIn, FaGoogle, FaGithub} from "react-icons/fa";
import Profile from "@/assets/images/Boom.png";
  ...
  return (
    <div className="w-[320px] bg-black border border-[#2a2a2e] rounded-[20px] p-6 shadow-xl">
      ...
      <div className="flex justify-center gap-6 mt-6 text-[26px] text-[#d4d4d8]">
        ...
        <a
          href="https://www.facebook.com/luchiwat.suchon"
          target="_blank"
        ...
        <a
          href="https://github.com/Luchiwat"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:text-[#ff6a00] transition"
        >
